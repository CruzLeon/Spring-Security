...
INSERT INTO user_second_project (username, name, password, role) VALUES ('user', 'user', 'password', 'ROLE_ADMIN');
INSERT INTO user_second_project (username, name, password, role) VALUES ('lmarquez', 'luis márquez','password', 'ROLE_CUSTOMER');
INSERT INTO user_second_project (username, name, password, role) VALUES ('fperez', 'fulano pérez', 'password', 'ROLE_ASSISTANT');
INSERT INTO user_second_project (username, name, password, role) VALUES ('mhernandez', 'mengano hernández', 'password', 'ROLE_ADMIN');
